...
public class TelaListar extends javax.swing.JFrame {
    ...
    /**
 * Método responsável por carregar os dados dos filmes na tabela.
 * Ele se conecta ao banco de dados, recupera a lista de filmes e preenche a tabela com esses dados.
 * 
 * @author Tiago
 */
    private void carregarTabela() {
        ...
        if (dao.conectar()) {
            ...
            for (Filme filme : filmes) {
                model.addRow(new Object[]{filme.getNome(), filme.getData(), filme.getCategoria()});
            }
        } else {
